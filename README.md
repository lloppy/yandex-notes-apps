# Описание
> Пять разных приложений, разные di (вариант с hilt, вариант через кастомную фабрику), разное разделение на модули, разная навигация (пропробовала в одном из приложений новую навигацию с сериализацией), mvvm и mvi архитектуры. Кастомные иконки, кастомные темы, экспортированные из composer Theme builder. В одном из приложений реализована смета темной/светлой темы.
